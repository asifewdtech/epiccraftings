...
function updateText(obj, inputNumber) {
    ...
    if((sence.offsetWidth - minusWidth) < $('.noenText1').width() && inputNumber == '1' ){
        let textFontSize = parseInt($('.noenText1')[0].style.fontSize) - 3;
        $('.noenText1')[0].style.fontSize = textFontSize+'px';
        $('.noenText1')[1].style.fontSize = textFontSize+'px';
        $('.noenText1').attr('data-size',textFontSize);
    }else if((sence.offsetWidth - minusWidth) < $('.noenText2').width()  && inputNumber == '2'){
        let textFontSize = parseInt($('.noenText2')[0].style.fontSize) - 3;
        $('.noenText2')[0].style.fontSize = textFontSize+'px';
        $('.noenText2')[1].style.fontSize = textFontSize+'px';
        $('.noenText2').attr('data-size',textFontSize);
    }else if((sence.offsetWidth - minusWidth) <  $('.noenText3').width() && inputNumber == '3'){
        let textFontSize = parseInt($('.noenText3')[0].style.fontSize) - 3;
        $('.noenText3')[0].style.fontSize = textFontSize+'px';
        $('.noenText3')[1].style.fontSize = textFontSize+'px';
        $('.noenText3').attr('data-size',textFontSize);
    }
    ...
    if(inputNumber === '1'){
        $('.first_input').val($(obj).val());
    }
    if(inputNumber === '2'){
        $('.second_input').val($(obj).val());
    }
    if(inputNumber === '3'){
        $('.third_input').val($(obj).val());
    }
