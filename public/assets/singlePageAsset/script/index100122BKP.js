...
function cost_calcultor(nText1, nText2, nText3) {
    ...
    var finalHeight = nText1 != null && nText2 == null && nText3 == null ? nText1[1].innerHTML!=''?(parseInt(nText1.attr("data-height"))):0 : nText1 != null && nText2 != null && nText3 == null ? (nText1[1].innerHTML!=''?(parseInt(nText1.attr("data-height"))):0) + (nText2[1].innerHTML!=''?(parseInt(nText2.attr("data-height"))):0) : (nText1[1].innerHTML!=''?(parseInt(nText1.attr("data-height"))):0) + (nText2[1].innerHTML!=''?(parseInt(nText2.attr("data-height"))):0) + (nText3[1].innerHTML!=''?(parseInt(nText3.attr("data-height"))):0);
    ...
    if (nText2 != null)
        ...
        var textOBJ = nText1;
    textOBJ[1].innerHTML!=''? finalHeight += get_height(textOBJ):finalHeight=0;
    ...
    total_cost = (shipping_cost + manufacture_cost) * 2.4;
    ...
    $('.price').html(total_cost < (60 * 2.4) ? (60 * 2.4) : total_cost);
...
function getRealTimeHeightAndPriceCommonCode(){
    var totalWidth = [];
    let totalHeight = 0.00;
    let totalPrice = 0.00;
    if($('.nav-link-tabs.active').data('tab')=="one"){
        let lineOneResponse = getRealTimeHeightAndPrice($(obj).val(), $("."+$('#noenText1').data('class')+".font-div").data('path') );
        totalHeight += lineOneResponse.success? parseFloat(lineOneResponse.height):0;
        if(lineOneResponse.success){ totalWidth.push(parseFloat(lineOneResponse.width));}
        totalPrice += lineOneResponse.success? parseFloat(lineOneResponse.totalCost):0;
    }else if($('.nav-link-tabs.active').data('tab')=="two"){
        ...
        totalHeight += lineTwoResponse.success? parseFloat(lineTwoResponse.height):0;
        if(lineTwoResponse.success){ totalWidth.push(parseFloat(lineTwoResponse.width));}
        totalPrice += lineTwoResponse.success? parseFloat(lineTwoResponse.totalCost):0;
    }else if($('.nav-link-tabs.active').data('tab')=="three"){
        ...
        totalHeight += lineThreeResponse.success? parseFloat(lineThreeResponse.height):0;
        if(lineThreeResponse.success){ totalWidth.push(parseFloat(lineThreeResponse.width));}
        totalPrice += lineThreeResponse.success? parseFloat(lineThreeResponse.totalCost):0;
    }
    ...
    textWidth.innerText = (Math.max(...totalWidth)).toFixed(2)+" inches";
