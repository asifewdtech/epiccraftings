    ...
    html2canvas(document.getElementById('sence'), {
        ...
        $.ajax({
            ...
            data: {
                ...
                line_one_font: $('.text-one-font-name').text().replace(';', '').replace(',', '')!="" ? $("."+$('.text-one-font-name').text().replace(';', '').replace(',', '')+".font-div").data('path') : "",
                line_two_font: $('.text-two-font-name').text().replace(';', '').replace(',', '')!="" ? $("."+$('.text-two-font-name').text().replace(';', '').replace(',', '')+".font-div").data('path') : "",
                line_three_font:$('.text-three-font-name').text().replace(';', '').replace(',', '')!="" ? $("."+$('.text-three-font-name').text().replace(';', '').replace(',', '')+".font-div").data('path') : "",
                ...
                deliver_date: $('.deliveryDate').text().replace(';', ''),
