                            ...
                            <div style="display: flex;margin-top:5px;" >
                                @foreach($product->images as $image)
                                    <div style="position:relative;width:100px;height:100px">
                                        <input type="hidden" name="old_image_ids[]" value="{{$image->id}}">
                                        <img class="mr-3" width="100" height="100" style="padding:12px;" src="{{$image->image_url}}">
                                        <span  onclick="removeFile(this)" style="padding: 0px;cursor:pointer;position: absolute;top: 4px;right: 6px;background: red;border-radius: 50%;width: 20px;height: 20px;">x</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>  
