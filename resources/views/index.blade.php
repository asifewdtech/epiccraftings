...
<section>
   ...
   <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
         <div class="carousel-item">
            <img src="{{asset('assets/img/Slider/slider.jpg')}}" class="d-block w-100 carouselHeight" alt="...">
            <div class="carousel-caption"></div>
         </div>
         <div class="carousel-item">
            <img src="{{asset('assets/img/Slider/slider1.jpg')}}" class="d-block w-100 carouselHeight" alt="...">
            <div class="carousel-caption"></div>
         </div>
         <div class="carousel-item">
            <img src="{{asset('assets/img/Slider/slider2.jpg')}}" class="d-block w-100 carouselHeight" alt="...">
            <div class="carousel-caption"></div>
         </div>
         <div class="carousel-item">
            <img src="{{asset('assets/img/Slider/slider3.jpg')}}" class="d-block w-100 carouselHeight" alt="...">
            <div class="carousel-caption"></div>
         </div>
         <div class="carousel-item active">
            <img src="{{asset('assets/img/Slider/slider4.jpg')}}" class="d-block w-100 carouselHeight" alt="...">
            <div class="carousel-caption"></div>
         </div>
         <div class="carousel-item">
            <img src="{{asset('assets/img/Slider/slider5.jpg')}}" class="d-block w-100 carouselHeight" alt="...">
            <div class="carousel-caption"></div>
         </div>
         <div class="carousel-item">
            <img src="{{asset('assets/img/Slider/slider6.jpg')}}" class="d-block w-100 carouselHeight" alt="...">
            <div class="carousel-caption"></div>
         </div>
         <div class="carousel-item">
            <img src="{{asset('assets/img/Slider/slider7.jpg')}}" class="d-block w-100 carouselHeight" alt="...">
            <div class="carousel-caption"></div>
         </div>
      </div>
      ...
      <div class="pt-1 pt-sm-2 pt-md-4 pt-lg-4 row m-0 h-100 align-items-center justify-content-center animate__animated animate__zoomInLeft">
         <div class="col-10 col-sm-7 col-md-7 col-lg-7">
            ...
            <div class="d-flex justify-content-center pt-1 pt-sm-2 pt-md-3 pt-lg-3 indexMainButtonDiv">
               <div class="d-inline">
                  <a href="{{ url('/design') }}">
                  <button class="btn buutonFontSize  bg-7E13AE text-white newButton f-22 font-w-600 w-100 px-lg-5 px-md-5 px-sm-3 px-3"
                     type="submit">Create Your Own Neon Sign</button>
                  </a>
               </div>
               <div class="d-inline ps-3">
                  <a href="{{ url('/shop') }}">
                  <button class="btn bg-7E13AE  buutonFontSize text-white newButton f-22 font-w-600 w-100 px-lg-5 px-md-5 px-sm-3 px-2"
   ...
   --}}
   <div>
      <div class="videoMainDiv" id="videoIphone" style="height: 850px;position:relative">
         <div class="video-overlay videoOverlayOne">
             <video autoplay loop muted playsinline class="w-100 h-100" src="{{asset('assets/video/mobile.mp4')}}" poster="{{asset('assets/img/Slider/slider8.png')}}">
            	<source src="{{asset('assets/video/mobile.mp4')}}" type="video/mp4"></source>
               <source  src="{{asset('assets/video/mobile.webm')}}" type="video/webm"></source>
        		<source src="{{asset('assets/video/mobile.mov')}}" type="video/mov"></source>
            </video>
   ...
   <div class="marginBanner" >
      <div class="bannar-image1 d-flex" style="background-image:url('{{asset('assets/img/bannar-1-sub.jpg')}}')">
         ...
         oNeonCrafts Is World’s Leading Manufacturer of Custom LED Neon Signs.
               ...
               <div class="bbb_main_container">
                  <div class="bbb_viewed_slider_container">
                     <div class="owl-carousel owl-theme bbb_viewed_slider">
                        <a  href="https://www.instagram.com/oneoncrafts/"> <img src="{{asset('assets/img/instagram-gallery/1.jpg')}}" alt="" srcset="">  </a>
                        <a href="https://www.instagram.com/oneoncrafts/"> <img src="{{asset('assets/img/instagram-gallery/2.jpg')}}" alt="" srcset=""></a>
                        <a href="https://www.instagram.com/oneoncrafts/"> <img src="{{asset('assets/img/instagram-gallery/3.jpg')}}" alt="" srcset=""></a>
                        <a href="https://www.instagram.com/oneoncrafts/"> <img src="{{asset('assets/img/instagram-gallery/4.jpg')}}" alt="" srcset=""></a>
                        <a href="https://www.instagram.com/oneoncrafts/"> <img src="{{asset('assets/img/instagram-gallery/5.jpg')}}" alt="" srcset=""></a>
                        <a href="https://www.instagram.com/oneoncrafts/"> <img src="{{asset('assets/img/instagram-gallery/6.jpg')}}" alt="" srcset=""></a>
                        <a href="https://www.instagram.com/oneoncrafts/"> <img src="{{asset('assets/img/instagram-gallery/7.jpg')}}" alt="" srcset=""></a>
                        <a href="https://www.instagram.com/oneoncrafts/"> <img src="{{asset('assets/img/instagram-gallery/8.jpg')}}" alt="" srcset=""></a>
                        <a href="https://www.instagram.com/oneoncrafts/"> <img src="{{asset('assets/img/instagram-gallery/9.jpg')}}" alt="" srcset=""></a>
                     </div>
                  </div>
                  <div class="bbb_viewed_nav_container">
