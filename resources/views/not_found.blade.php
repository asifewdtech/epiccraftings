    ...
    <div class="row m-0 justify-content-center align-items-center h-100vh" style="height:100vh;">
        <div class="col-md-10 col-lg-9 col-sm-10  ">
                <div class="w-75 m-auto">
                    <img src="{{asset('assets/img/page_not_found.svg')}}" alt="" class="img-fluid w-100">
                </div>
                <div class="h1 py-3 m-0 text-center">404 Page Not Found</div>
                <p class="text-center h5" style="font-weight: 400;">Please contact with our support at <a href="mailto:info@oneoncrafts.com">info@oneoncrafts.com</a> </p>
        </div>
    </div>
</section>
